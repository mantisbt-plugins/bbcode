...
class BBCodePlugin extends MantisFormattingPlugin {
    ...
    function resources( $p_event ) {
        return '<link href="' . plugin_file( 'bbcode.css' ) . '" media="all" rel="stylesheet" type="text/css"/>';
    }
    ...
    private function replaceQuotes($matches) {
        ...
        $replacement = sprintf('<div class="bbcode-quote"><i>%s wrote</i><br/><br/>%s</div>', $matches[1], $matches[2]);
        return $replacement;
    }
} // end class